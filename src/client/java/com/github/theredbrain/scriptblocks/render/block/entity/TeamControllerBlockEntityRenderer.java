...
public class TeamControllerBlockEntityRenderer implements BlockEntityRenderer<TeamControllerBlockEntity> {
	public TeamControllerBlockEntityRenderer(BlockEntityRendererFactory.Context ctx) {
	}

	@Override
	public void render(TeamControllerBlockEntity blockEntity, float f, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, int j) {
		double o;
		double n;
		double m;
		double k;
	...
	private void renderInvisibleBlocks(TeamControllerBlockEntity entity, VertexConsumer vertices, BlockPos pos, MatrixStack matrices) {
	...
	@Override
	public boolean rendersOutsideBoundingBox(TeamControllerBlockEntity teamControllerBlockEntity) {
		return true;
	}

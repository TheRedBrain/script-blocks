...
public class TriggeredDamageDealingBlockEntityRenderer implements BlockEntityRenderer<TriggeredDamageDealingBlockEntity> {
	public TriggeredDamageDealingBlockEntityRenderer(BlockEntityRendererFactory.Context ctx) {
	}

	@Override
	public void render(TriggeredDamageDealingBlockEntity blockEntity, float f, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, int j) {
		double o;
		double n;
		double m;
		double k;
		...
		BlockPos blockPos = blockEntity.getAreaPositionOffset();
		Vec3i vec3i = blockEntity.getAreaDimensions();
	...
	private void renderInvisibleBlocks(TriggeredDamageDealingBlockEntity entity, VertexConsumer vertices, BlockPos pos, MatrixStack matrices) {
	...
	@Override
	public boolean rendersOutsideBoundingBox(TriggeredDamageDealingBlockEntity triggeredEntityRemoverBlockEntity) {
		return true;
	}

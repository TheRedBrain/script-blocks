...
//		}));
//
//		/* TODO button switch between read/write
//		    dataValueThreshold field
//		    write mode add/set
//		    dataValue field
//		 */
//		this.dataIdentifierField = new TextFieldWidget(this.textRenderer, this.width / 2 - 154, 140, 300, 20, Text.empty());

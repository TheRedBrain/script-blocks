...
public class JigsawPlacerBlockScreen extends Screen {
	...
	private static final Text STRUCTURE_POOL_FIELD_TEXT = Text.translatable("gui.jigsaw_placer_block.structure_pool_field");
	private final JigsawPlacerBlockEntity jigsawPlacerBlock;
	private TextFieldWidget structurePoolField;
	...
	protected void init() {
		...
		this.structurePoolField = new TextFieldWidget(this.textRenderer, this.width / 2 - 154, 81, 200, 20, Text.empty());
		this.structurePoolField.setMaxLength(128);
		this.structurePoolField.setText(this.jigsawPlacerBlock.getStructurePool());
		this.structurePoolField.setChangedListener(structurePool -> this.updateDoneButtonState());
		this.addSelectableChild(this.structurePoolField);
...
//		}));
	...
	protected void setInitialFocus() {
		this.setInitialFocus(this.structurePoolField);
	}
	...
	private void updateDoneButtonState() {
		...
		Identifier id2 = Identifier.tryParse(this.structurePoolField.getText());
	...
	public void resize(MinecraftClient client, int width, int height) {
		...
		String string8 = this.structurePoolField.getText();
		...
		this.structurePoolField.setText(string8);
		this.joint = joint;
	...
	private boolean updateJigsawPlacerBlock() {
		ClientPlayNetworking.send(new UpdateJigsawPlacerBlockPacket(
				...
				this.structurePoolField.getText(),
				this.joint,
				new BlockPos(
	...
	public void render(DrawContext context, int mouseX, int mouseY, float delta) {
		...
		context.drawTextWithShadow(this.textRenderer, STRUCTURE_POOL_FIELD_TEXT, this.width / 2 - 153, 71, 0xA0A0A0);
		this.structurePoolField.render(context, mouseX, mouseY, delta);

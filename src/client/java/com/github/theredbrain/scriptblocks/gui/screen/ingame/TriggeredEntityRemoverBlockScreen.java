...
public class TriggeredEntityRemoverBlockScreen extends Screen {
	...
	private final TriggeredEntityRemoverBlockEntity triggeredEntityRemoverBlock;
	...
	public TriggeredEntityRemoverBlockScreen(TriggeredEntityRemoverBlockEntity triggeredEntityRemoverBlock) {
		super(NarratorManager.EMPTY);
		this.triggeredEntityRemoverBlock = triggeredEntityRemoverBlock;
	}
	...
	protected void init() {
		...
		this.showArea = this.triggeredEntityRemoverBlock.showArea();
		...
		this.areaDimensionsXField.setText(Integer.toString(this.triggeredEntityRemoverBlock.getAreaDimensions().getX()));
		...
		this.areaDimensionsYField.setText(Integer.toString(this.triggeredEntityRemoverBlock.getAreaDimensions().getY()));
		...
		this.areaDimensionsZField.setText(Integer.toString(this.triggeredEntityRemoverBlock.getAreaDimensions().getZ()));
		...
		this.areaPositionOffsetXField.setText(Integer.toString(this.triggeredEntityRemoverBlock.getAreaPositionOffset().getX()));
		...
		this.areaPositionOffsetYField.setText(Integer.toString(this.triggeredEntityRemoverBlock.getAreaPositionOffset().getY()));
		...
		this.areaPositionOffsetZField.setText(Integer.toString(this.triggeredEntityRemoverBlock.getAreaPositionOffset().getZ()));
	...
	private void updateBossControllerBlock() {
		ClientPlayNetworking.send(new UpdateTriggeredEntityRemoverBlockPacket(
				this.triggeredEntityRemoverBlock.getPos(),
				this.showArea,
				new Vec3i(

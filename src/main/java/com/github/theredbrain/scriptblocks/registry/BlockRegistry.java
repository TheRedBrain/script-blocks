...
public class BlockRegistry {
	...
	public static final Block INTERACTIVE_TRIGGER_CANDLE = registerBlock("interactive_trigger_candle", new InteractiveTriggerCandleBlock(Block.Settings.create().mapColor(MapColor.PALE_YELLOW).requiresTool().strength(-1.0f, 3600000.0f).nonOpaque().dropsNothing().luminance(CandleBlock.STATE_TO_LUMINANCE)), ItemGroupRegistry.DECORATIVE_SCRIPT_BLOCKS);
	public static final Block INTERACTIVE_TRIGGER_WHITE_CANDLE = registerBlock("interactive_trigger_white_candle", new InteractiveTriggerCandleBlock(Block.Settings.create().mapColor(MapColor.WHITE_GRAY).requiresTool().strength(-1.0f, 3600000.0f).nonOpaque().dropsNothing().luminance(CandleBlock.STATE_TO_LUMINANCE)), ItemGroupRegistry.DECORATIVE_SCRIPT_BLOCKS);
	...
	public static final Block INTERACTIVE_TRIGGER_MAGENTA_CANDLE = registerBlock("interactive_trigger_magenta_candle", new InteractiveTriggerCandleBlock(Block.Settings.create().mapColor(MapColor.MAGENTA).requiresTool().strength(-1.0f, 3600000.0f).nonOpaque().dropsNothing().luminance(CandleBlock.STATE_TO_LUMINANCE)), ItemGroupRegistry.DECORATIVE_SCRIPT_BLOCKS);
	public static final Block INTERACTIVE_TRIGGER_LIGHT_BLUE_CANDLE = registerBlock("interactive_trigger_light_blue_candle", new InteractiveTriggerCandleBlock(Block.Settings.create().mapColor(MapColor.LIGHT_BLUE).requiresTool().strength(-1.0f, 3600000.0f).nonOpaque().dropsNothing().luminance(CandleBlock.STATE_TO_LUMINANCE)), ItemGroupRegistry.DECORATIVE_SCRIPT_BLOCKS);
	public static final Block INTERACTIVE_TRIGGER_YELLOW_CANDLE = registerBlock("interactive_trigger_yellow_candle", new InteractiveTriggerCandleBlock(Block.Settings.create().mapColor(MapColor.YELLOW).requiresTool().strength(-1.0f, 3600000.0f).nonOpaque().dropsNothing().luminance(CandleBlock.STATE_TO_LUMINANCE)), ItemGroupRegistry.DECORATIVE_SCRIPT_BLOCKS);
	public static final Block INTERACTIVE_TRIGGER_LIME_CANDLE = registerBlock("interactive_trigger_lime_candle", new InteractiveTriggerCandleBlock(Block.Settings.create().mapColor(MapColor.LIME).requiresTool().strength(-1.0f, 3600000.0f).nonOpaque().dropsNothing().luminance(CandleBlock.STATE_TO_LUMINANCE)), ItemGroupRegistry.DECORATIVE_SCRIPT_BLOCKS);
	public static final Block INTERACTIVE_TRIGGER_PINK_CANDLE = registerBlock("interactive_trigger_pink_candle", new InteractiveTriggerCandleBlock(Block.Settings.create().mapColor(MapColor.PINK).requiresTool().strength(-1.0f, 3600000.0f).nonOpaque().dropsNothing().luminance(CandleBlock.STATE_TO_LUMINANCE)), ItemGroupRegistry.DECORATIVE_SCRIPT_BLOCKS);
	public static final Block INTERACTIVE_TRIGGER_GRAY_CANDLE = registerBlock("interactive_trigger_gray_candle", new InteractiveTriggerCandleBlock(Block.Settings.create().mapColor(MapColor.GRAY).requiresTool().strength(-1.0f, 3600000.0f).nonOpaque().dropsNothing().luminance(CandleBlock.STATE_TO_LUMINANCE)), ItemGroupRegistry.DECORATIVE_SCRIPT_BLOCKS);
	public static final Block INTERACTIVE_TRIGGER_LIGHT_GRAY_CANDLE = registerBlock("interactive_trigger_light_gray_candle", new InteractiveTriggerCandleBlock(Block.Settings.create().mapColor(MapColor.LIGHT_GRAY).requiresTool().strength(-1.0f, 3600000.0f).nonOpaque().dropsNothing().luminance(CandleBlock.STATE_TO_LUMINANCE)), ItemGroupRegistry.DECORATIVE_SCRIPT_BLOCKS);
	...
	public static final Block INTERACTIVE_TRIGGER_PURPLE_CANDLE = registerBlock("interactive_trigger_purple_candle", new InteractiveTriggerCandleBlock(Block.Settings.create().mapColor(MapColor.PURPLE).requiresTool().strength(-1.0f, 3600000.0f).nonOpaque().dropsNothing().luminance(CandleBlock.STATE_TO_LUMINANCE)), ItemGroupRegistry.DECORATIVE_SCRIPT_BLOCKS);
	public static final Block INTERACTIVE_TRIGGER_BLUE_CANDLE = registerBlock("interactive_trigger_blue_candle", new InteractiveTriggerCandleBlock(Block.Settings.create().mapColor(MapColor.BLUE).requiresTool().strength(-1.0f, 3600000.0f).nonOpaque().dropsNothing().luminance(CandleBlock.STATE_TO_LUMINANCE)), ItemGroupRegistry.DECORATIVE_SCRIPT_BLOCKS);
	...
	public static final Block INTERACTIVE_TRIGGER_GREEN_CANDLE = registerBlock("interactive_trigger_green_candle", new InteractiveTriggerCandleBlock(Block.Settings.create().mapColor(MapColor.GREEN).requiresTool().strength(-1.0f, 3600000.0f).nonOpaque().dropsNothing().luminance(CandleBlock.STATE_TO_LUMINANCE)), ItemGroupRegistry.DECORATIVE_SCRIPT_BLOCKS);
	public static final Block INTERACTIVE_TRIGGER_RED_CANDLE = registerBlock("interactive_trigger_red_candle", new InteractiveTriggerCandleBlock(Block.Settings.create().mapColor(MapColor.RED).requiresTool().strength(-1.0f, 3600000.0f).nonOpaque().dropsNothing().luminance(CandleBlock.STATE_TO_LUMINANCE)), ItemGroupRegistry.DECORATIVE_SCRIPT_BLOCKS);
	public static final Block INTERACTIVE_TRIGGER_BLACK_CANDLE = registerBlock("interactive_trigger_black_candle", new InteractiveTriggerCandleBlock(Block.Settings.create().mapColor(MapColor.BLACK).requiresTool().strength(-1.0f, 3600000.0f).nonOpaque().dropsNothing().luminance(CandleBlock.STATE_TO_LUMINANCE)), ItemGroupRegistry.DECORATIVE_SCRIPT_BLOCKS);

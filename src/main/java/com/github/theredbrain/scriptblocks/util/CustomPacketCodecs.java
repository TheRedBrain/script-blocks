...
public class CustomPacketCodecs {
	...
	public static final PacketCodec<ByteBuf, MutablePair<MutablePair<String, String>, MutablePair<String, String>>> MUTABLE_PAIR_MUTABLE_PAIR_STRING_STRING_MUTABLE_PAIR_STRING_STRING = new PacketCodec<>() {
		public MutablePair<MutablePair<String, String>, MutablePair<String, String>> decode(ByteBuf byteBuf) {
			return new MutablePair<>(new MutablePair<>(PacketCodecs.STRING.decode(byteBuf), PacketCodecs.STRING.decode(byteBuf)), new MutablePair<>(PacketCodecs.STRING.decode(byteBuf), PacketCodecs.STRING.decode(byteBuf)));
		}

		public void encode(ByteBuf byteBuf, MutablePair<MutablePair<String, String>, MutablePair<String, String>> pairStringString) {
			PacketCodecs.STRING.encode(byteBuf, pairStringString.getLeft().getLeft());
			PacketCodecs.STRING.encode(byteBuf, pairStringString.getLeft().getRight());
			PacketCodecs.STRING.encode(byteBuf, pairStringString.getRight().getLeft());
			PacketCodecs.STRING.encode(byteBuf, pairStringString.getRight().getRight());
		}
	};
	...
	public static final PacketCodec<ByteBuf, MutablePair<BlockPos, MutablePair<Double, Double>>> MUTABLE_PAIR_BLOCK_POS_MUTABLE_PAIR_DOUBLE_DOUBLE = new PacketCodec<>() {
		public MutablePair<BlockPos, MutablePair<Double, Double>> decode(ByteBuf byteBuf) {
			return new MutablePair<>(BlockPos.PACKET_CODEC.decode(byteBuf), new MutablePair<>(PacketCodecs.DOUBLE.decode(byteBuf), PacketCodecs.DOUBLE.decode(byteBuf)));
		}

		public void encode(ByteBuf byteBuf, MutablePair<BlockPos, MutablePair<Double, Double>> pairStringPairDoubleDouble) {
			BlockPos.PACKET_CODEC.encode(byteBuf, pairStringPairDoubleDouble.getLeft());
			PacketCodecs.DOUBLE.encode(byteBuf, pairStringPairDoubleDouble.getRight().getLeft());
			PacketCodecs.DOUBLE.encode(byteBuf, pairStringPairDoubleDouble.getRight().getRight());
		}
	};
}

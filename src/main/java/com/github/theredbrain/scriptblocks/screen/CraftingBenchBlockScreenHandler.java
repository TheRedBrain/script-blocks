...
//import com.github.theredbrain.scriptblocks.data.CraftingRecipe;
//import com.github.theredbrain.scriptblocks.entity.player.DuckPlayerEntityMixin;
//import com.github.theredbrain.scriptblocks.network.packet.CraftFromCraftingBenchPacket;
//import com.github.theredbrain.scriptblocks.registry.CraftingRecipeRegistry;
...
//        this(syncId, playerInventory, playerInventory.player.getEnderChestInventory(), ((DuckPlayerEntityMixin)playerInventory.player).scriptblocks$getStashInventory(), buf.readBlockPos(), buf.readInt(), buf.readByte(), buf.readByte(), buf.readIntArray());
//    }
//
...
//                                ((DuckPlayerEntityMixin)player).scriptblocks$useStashForCrafting()
//                        )
//                );
//            }
...
//                }
////                boolean bl = !this.world.getGameRules().getBoolean(GameRules.DO_LIMITED_CRAFTING) || unlockAdvancementIdentifier.equals("") || (unlockAdvancementEntry != null && ((DuckClientAdvancementManagerMixin) advancementHandler.getManager()).scriptblocks$getAdvancementProgress(unlockAdvancementEntry).isDone());
//                boolean bl = !this.world.getGameRules().getBoolean(GameRules.DO_LIMITED_CRAFTING) || unlockAdvancementIdentifier.equals("") || (unlockAdvancement != null && ((DuckClientAdvancementManagerMixin) advancementHandler.getManager()).scriptblocks$getAdvancementProgress(unlockAdvancement).isDone());
//
//                if (bl) {

...
//import com.github.theredbrain.scriptblocks.inventory.AdditionalPlayerInventory;
...
//        this.backpackInventory = ((DuckPlayerEntityMixin) playerInventory.player).scriptblocks$getBackpackInventory();
//        this.backpackCapacity = ((DuckPlayerEntityMixin) playerInventory.player).scriptblocks$getBackpackCapacity();
//
//        int i;
//        // hotbar 0 - 8
//        for (i = 0; i < 9; ++i) {

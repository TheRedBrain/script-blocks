...
public class LocationControlBlockScreen extends Screen {
    ...
    protected void init() {
        ...
        this.triggeredBlockPositionOffsetXField.setText(Integer.toString(this.locationControlBlock.getTriggeredBlock().getLeft().getX()));
        ...
        this.triggeredBlockPositionOffsetYField.setText(Integer.toString(this.locationControlBlock.getTriggeredBlock().getLeft().getY()));
        ...
        this.triggeredBlockPositionOffsetZField.setText(Integer.toString(this.locationControlBlock.getTriggeredBlock().getLeft().getZ()));
        this.addSelectableChild(this.triggeredBlockPositionOffsetZField);

        this.triggeredBlockResets = this.locationControlBlock.getTriggeredBlock().getRight();
